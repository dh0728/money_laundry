...
- phase: PREPARE/PUBLISH/WAIT_REMOTE/COLLECT/DONE. status: READY/ACTIVE/WAITING/RETRY_WAIT/SUCCEEDED/FAILED/CANCELLED. 현재 실행 연결은 PREPARE→PUBLISH→WAIT_REMOTE→COLLECT/READY까지다. COLLECT 파일 검증·점수 저장·DONE 전이는 아직 연결 전이다.
