...
public class WebConfig implements WebMvcConfigurer {
  ...
  private final BankApiKeyInterceptor bankApiKeyInterceptor;

  public WebConfig(BankApiKeyInterceptor bankApiKeyInterceptor) {
    this.bankApiKeyInterceptor = bankApiKeyInterceptor;
  }
