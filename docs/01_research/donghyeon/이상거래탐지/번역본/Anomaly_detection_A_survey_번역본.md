...
정보 이론 √ 스펙트럼 √ 애플리케이션 사이버 침입 감지 √ √ 사기 감지 √ 의료 이상 탐지 √ 산업 피해 감지 √ 이미지 처리 √ 텍스트 이상 탐지 √ 센서 네트워크 √ 표 I. 설문 조사와 기타 관련 설문 조사 기사 비교 1 - 설문 조사 2 - Hodge and Austin [2004], 3 - Agyeman et al. [2006], 4 - Markou 및 Singh [2003a], 5 - Markou 및 Singh [2003b], 6 - Patcha 및 Park [2007], 7 - Beckman 및 Cook [1983], 8 - Bakar 외 [2006]
...
호스트 기반 침입 탐지에 적용되는 것은 데이터의 순차적 특성을 처리하는 데 필요합니다. 또한 이 영역에서는 포인트 이상 탐지 기술을 적용할 수 없습니다. 기술은 시퀀스 데이터를 모델링하거나 시퀀스 간의 유사성을 계산해야 합니다. 이 문제에 사용된 다양한 기술에 대한 조사가 Snyder [2001]에 의해 발표되었습니다. Forrest et al.에서 제시된 호스트 기반 침입 탐지에 대한 이상 탐지의 비교 평가. [1996] 및 Dasgupta 및 기술 사용 섹션 참조 히스토그램을 사용한 통계적 프로파일링 섹션 7.2.1 Forrest et al [1996; 2004; 1996; 1994; 1999],Hofmeyr et al. [1998] Kosoresow 및 Hofmeyr [1997] Jagadish et al. [1999] 카브레라 외 여러분. [2001] Gonzalez 및 Dasgupta [2003] Dasgupta 외 [2000; 2002] Ghosh 외 [1999a; 1998; 1999b] Debaret al. [1998] Eskin et al. [2001] Marceau [2000] Endler [1998] Lane 외 [1999; 1997b; 1997a] 모델 혼합 섹션 7.1.3 Eskin [2000] 신경망 섹션 4.1 Ghosh et al. [1998] 지원 벡터 머신 섹션 4.3 Hu et al. [2003] 헬러 외. [2003]

<!-- 원문 15쪽 -->

규칙 기반 시스템 섹션 4.4 Lee et al[1997; 1998; 2000]
...
Fawcett 및 Provost [1999]는 이러한 영역에서 사기 탐지에 대한 일반적인 접근 방식으로 활동 모니터링이라는 용어를 소개합니다. 이상 징후의 일반적인 접근 방식 사용된 섹션 참조 히스토그램을 사용한 통계적 프로파일링 섹션 7.2.1 NIDES [Anderson et al. 1994; Andersonet al. 1995; Javitz 및 Valdes 1991], EMERALD [Porras 및 Neumann 1997], Yamanishi 외 [2001; 2004], Ho 외. [1999], Kruegel at al [2002; 2003], Mahoney et al [2002; 2003; 2003; 2007], Sargor [1998] 매개변수 통계 모델링 섹션 7.1 Gwadera et al [2005b; 2004], 예(Ye) 및 첸(Chen) [2001]

<!-- 원문 16쪽 -->

비모수적 통계 모델링 섹션 7.2.2 Chow and Yeung [2002]

베이지안 네트워크 섹션 4.2 Siaterlis 및 Maglaris [2004], Sebyala et al. [2002], Valdes 및 Skinner [2000], Bronstein 외. [2001] 신경망 섹션 4.1 숨기기 [Zhang et al. 2001], NSOM [Labib 및 Vemuri 2002], Smith et al. [2002], 호킨스 외. [2002], Kruegel 외. [2003], Manikopoulos 및 Papavassiliou [2002], Ramadas et al. [2003] 지원 벡터 머신 섹션 4.3 Eskin et al. [2002]

규칙 기반 시스템 섹션 4.4 ADAM [Barbara et al. 2001a; Barbaraet al. 2003; Barbaraet al. 2001b], 팬 외. [2001], 헬머 외 여러분. [1998], Qin 및 Hwang [2004], Salvador 및 Chan [2003], Otey 외. [2003] 클러스터링 기반 섹션 6 ADMIT [Sequeira 및 Zaki 2002], Eskin et al. [2002], Wu 및 Zhang [2003], Otey 외. [2003] 가장 가까운 이웃 기반 섹션 5 MINDS [Ertoz et al. 2004; Chandolaet al. 2006], Eskin et al. [2002] 스펙트럼 섹션 9 Shyu et al. [2003], Lakhina 외. [2005], Thottan 및 Ji [2003], Sun 외. [2007] 정보이론편 8 Lee and Xiang [2001],Noble and Cook [2003]

표 III. 네트워크 침입 탐지에 사용되는 이상 탐지 기술의 예입니다.

사용된 기술 섹션 참조 신경망 섹션 4.1 CARDWATCH [Aleskerov et al. 1997], Ghosh 및 Reilly [1994], Brause 외. [1999], Dorronsoro 외. [1997] 규칙 기반 시스템 섹션 4.4 Brause et al. [1999] 클러스터링 섹션 6 Bolton 및 Hand [1999]

표 4. 신용카드 사기 탐지에 사용되는 이상 탐지 기술의 예. 탐지 기술은 각 고객의 사용 프로필을 유지하고 프로필을 모니터링하여 편차를 탐지하는 것입니다. 사기 탐지의 구체적인 적용 사례 중 일부는 아래에 설명되어 있습니다.
...
사용된 기술 섹션 참조 히스토그램을 사용한 통계적 프로파일링 섹션 7.2.1 Fawcett 및 Provost [1999],Cox et al. [1997]

파라메트릭 통계 모델링 섹션 7.1 Agarwal [2005],Scott [2001]

신경망 섹션 4.1 Barson et al. [1996],Taniguchi 외. [1998] 규칙 기반 시스템 섹션 4.4 Phua et al. [2004],Taniguchi 외. [1998]
...
사용된 기술 섹션 참조 히스토그램을 사용한 통계적 프로파일링 섹션 7.2.1 Donoho [2004],Aggarwal [2005]

정보 이론 섹션 8 Arning et al. [1996]
...
데이터는 일반적으로 환자 연령, 혈액형, 체중과 같은 여러 가지 유형의 특징을 가질 수 있는 기록으로 구성됩니다. 데이터에는 기술 사용 섹션 참조 파라메트릭 통계 모델링 섹션 7.1 Horn et al. [2001],Laurikkala 외. [2000], 솔버그 및 라티 [2005], 로버츠 [2002], 스즈키 외. [2003] 신경망 섹션 4.1 Campbell 및 Bennett [2001] 베이지안 네트워크 섹션 4.2 Wong et al. [2003] 규칙 기반 시스템 섹션 4.4 Aggarwal [2005] 최근접 이웃 기반 기술 섹션 5 Lin et al. [2005]

<!-- 원문 19쪽 -->

표 Ⅶ. 의료 및 공중 보건 영역에서 사용되는 다양한 이상 탐지 기술의 예입니다. 시간적 측면뿐만 아니라 공간적 측면도 마찬가지다. 이 영역에서 현재 이상 탐지 기술의 대부분은 비정상적인 기록(포인트 이상)을 탐지하는 것을 목표로 합니다. 일반적으로 레이블이 지정된 데이터는 건강한 환자에 속하므로 대부분의 기술은 준지도 방식을 채택합니다. 이 영역에서 이상 탐지 기술로 처리되는 또 다른 형태의 데이터는 심전도(ECG)(그림 4) 및 뇌전도(EEG)와 같은 시계열 데이터입니다. 이러한 데이터에서 이상을 탐지하기 위해 집단적 이상 탐지 기술이 적용되었습니다 [Lin et al. 2005].
...
사용된 기술 섹션 참조 파라메트릭 통계 모델링 섹션 7.1 Guttormsson et al. [1999], Keogh 외 [1997; 2002; 2006] 비모수적 통계 모델링 섹션 7.2.2 Desforges 외. [1998]

신경망 섹션 4.1 Bishop [1994], Campbell 및 Bennett [2001], Diaz 및 Hollmen [2002], Harris [1993], Jakubek 및 Strasser [2002], King 외. [2002], 리 외 여러분. [2002], Petsche 등. [1996], Streifel et al. [1996], Whitehead 및 Hoyt [1993] 스펙트럼 섹션 9 Parra et al. [1996], Fujimaki 외. [2005] 규칙 기반 시스템 섹션 4.4 Yairi et al. [2001]

표 8. 기계 장치의 결함 감지에 사용되는 이상 탐지 기술의 예입니다.

사용된 기술 섹션 참조 히스토그램을 사용한 통계적 프로파일링 섹션 7.2.1 Manson [2002],Manson et al. [2001], 맨슨 외. [2000] 매개변수 통계 모델링 섹션 7.1 Ruotolo 및 Surace [1997]

모델 혼합 섹션 7.1.3 Hickinbotham 외 [2000a; 2000b],Hollier 및 Austin [2002] 신경망 섹션 4.1 Brotherton 외 [1998; 2001], Nairac 외 [1999; 1997], Surace 외 [1998; 1997], Sohn 외. [2001], 워든 [1997]
...
이미지를 다루는 이상 탐지 기술은 시간에 따른 이미지의 변화(모션 감지)나 정적 이미지에서 비정상적으로 나타나는 영역에 관심이 있습니다. 이 도메인에는 위성 이미지 [Augusteijn 및 Folkert 2002; 바이어스 앤 래프터리 1998; Moyaet al. 1993; 토르 및 머레이 1993; Theiler 및 Cai 2003], 숫자 인식 [Cun et al. 1990], 분광학 [Chen et al. 2005; 데이비와 Godsill 2002; 헤이젤 2000; Scarthet al. 1995], 유방촬영 영상분석[Spence et al. 2001; Tarassenko 1995] 및 비디오 감시 [Diehl 및 Hampshire 2002; Singh 및 Markou 2004; Pokrajacet al. 2007]. 이상 현상은 이물질의 움직임이나 삽입 또는 계측 오류로 인해 발생합니다. 데이터에는 공간적 특성과 시간적 특성이 있습니다. 각 데이터 포인트에는 몇 가지 연속 기술 사용 섹션 참조 모델 혼합 섹션 7.1.3 Byers 및 Raftery [1998],Spence et al. [2001],Tarassenko [1995] 회귀 섹션 7.1.2 Chen et al. [2005], Torr 및 Murray [1993] 베이지안 네트워크 섹션 4.2 Diehl 및 Hampshire [2002] 지원 벡터 머신 섹션 4.3 Davy 및 Godsill [2002],Song et al. [2002]

<!-- 원문 21쪽 -->

신경망 섹션 4.1 Augusteijn 및 Folkert [2002], Cun et al. [1990], 헤이즐 [2000], Moya 외. [1993], Singh 및 Markou [2004] 클러스터링 섹션 6 Scarth et al. [1995] 최근접 이웃 기반 기술 섹션 5 Pokrajac et al. [2007], 바이어스 및 래프터리 [1998]

표 X. 이미지 처리 영역에서 사용되는 이상 탐지 기술의 예.

사용된 기술 섹션 참조 모델 혼합 섹션 7.1.3 Baker et al. [1999] 히스토그램 섹션 7.2.1를 사용한 통계적 프로파일링 Fawcett 및 Provost [1999]

서포트 벡터 머신 섹션 4.3 Manevitz 및 Yousef [2002]

신경망 섹션 4.1 Manevitz 및 Yousef [2000] 클러스터링 기반 섹션 6 Allan et al. [1998],스리바스타바 및 제인-울만 [2005],스리바스타바 [2006]

표 11. 텍스트 데이터에서 변칙 주제 탐지에 사용되는 변칙 탐지 기술의 예입니다. 색상, 밝기, 질감 등과 같은 속성. 흥미로운 이상 현상은 이미지의 비정상적인 점 또는 영역(점 및 상황적 이상)입니다.
...
센서 네트워크는 최근 중요한 연구 주제가 되었습니다. 다양한 무선 센서로부터 수집된 센서 데이터는 몇 가지 고유한 특성을 가지고 있기 때문에 데이터 분석 관점에서 더 많은 정보를 얻을 수 있습니다. 센서에서 수집된 데이터의 이상 현상 사용된 섹션 참조 베이지안 네트워크 섹션 4.2 Janakiram et al. [2006] 규칙 기반 시스템 섹션 4.4 Branch et al. [2006] 파라메트릭 통계 모델링 섹션 7.1 Phuong et al. [2006], Du 외. [2006]

<!-- 원문 22쪽 -->

최근접 이웃 기반 기술 섹션 5 Subramaniam et al. [2006], Kejia Zhang 및 Li [2007], Id'e 외. [2007] 스펙트럼 섹션 9 Chatzigiannakis et al. [2006]

표 12. 센서 네트워크의 이상 탐지에 사용되는 이상 탐지 기술의 예입니다. 네트워크는 하나 이상의 센서에 결함이 있거나 분석가에게 흥미로운 이벤트(예: 침입)를 감지하고 있음을 의미할 수 있습니다. 따라서 센서 네트워크의 이상 탐지는 센서 결함 감지나 침입 감지 또는 둘 다를 포착할 수 있습니다.
...
사용된 신경망 참조 다층 퍼셉트론 [Augusteijn 및 Folkert 2002; Cun et al. 1990; Sykacek 1997; Ghoshet al. 1999a; Ghoshet al. 1998; Barsonet al. 1996; 그 외 여러분. 1997; Nairacet al. 1997; Hickinbotham과 Austin 2000b; Vasconceloset al. 1995; 1994] 신경 트리 [Martinez 1998] 자동 연관 네트워크 [Aeyels 1991; 병호와 성준 1999; Japkowiczet al. 1995; Hawkinset al. 2002; Ko 및 Jacyna 2000; 마네비츠(Manevitz)와 유세프(Yousef) 2000; Petscheet al. 1996; 손 외. 2001; Songet al. 2001; Streifelet al. 1996; Thompsonet al. 2002; 워든 1997; Williamset al. 2002; Diaz and Hollmen 2002] 적응형 공명 이론 기반 [Moya et al. 1993; 다스굽타(Dasgupta) 및 니노(Nino) 2000; Caudell 및 Newman 1993] 방사형 기초 함수 기반 [Albrecht et al. 2000; 주교 1994; Brothertonet al. 1998; 브라더턴 앤 존슨 2001; Li et al. 2002; Nairacet al. 1999; Nairacet al. 1997; 고쉬와 라일리 1994; Jakubek 및 Strasser 2002] Hopfield Networks [Jagota 1991; 크룩 앤 헤이즈 2001; Crooket al. 2002; Addisonet al. 1999; 머레이 2001] 진동 네트워크 [Ho 및 Rouat 1997; 1998; 코지마와 이토 1999; Borisyuket al. 2000; 마르티넬리와 퍼페티 1994]
...
회귀를 이용한 이상 탐지는 시계열 데이터에 대해 폭넓게 연구되어 왔습니다 [Abraham and Chuang 1989; Abraham and Box 1979; Fox 1972].
