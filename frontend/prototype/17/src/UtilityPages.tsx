...
import { Camera, Monitor, Laptop, Bell, Check, Sun, Moon, LaptopMinimal, RotateCcw, Search, History, ArrowDownWideNarrow, ArrowUpNarrowWide } from 'lucide-react'
  ...
  return (
    <div className="notification-column min-w-0">
      <div className="flex items-center gap-2 mb-3">
        <Button variant="ghost" size="icon" className="size-7 text-muted-foreground" aria-label={order === 'desc' ? '최신순' : '오래된순'} title={order === 'desc' ? '최신순' : '오래된순'} onClick={onToggleOrder}>
