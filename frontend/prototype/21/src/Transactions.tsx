...
export default function Transactions({ records, target, onOpenRecord }: { records: RecordItem[]; target?: TransactionTarget; onOpenRecord?: (record: RecordItem) => void }) {
  ...
  return (
    <div className="flex flex-col gap-5" data-testid="transactions-table">
      ...
      <DataTable table={table} tableClassName="min-w-[1800px]" floatingHorizontalScrollbar onRowClick={selectRow} data-testid="transaction-tree-table" />
