...
describe('Figma v18 · T2 정렬 활성 상태가 아이콘 반전과 머리글 강조로 분명하다', () => {
  ...
  it('index.css의 aria-sort 머리글은 테마 의미색으로 은은하게 강조된다', () => {
    ...
    expect(css).toContain('background:color-mix(in oklch,var(--foreground) 12%,var(--background))')
